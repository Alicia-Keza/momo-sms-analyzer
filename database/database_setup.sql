...
create table sms_messages(
    sms_id BIGINT UNSIGNED  NOT NULL auto_increment primary key,
...
create table accounts(
    ...
    constraint fk_accounts_user
     foreign key (user_id) references users(user_id) on delete cascade restrict on update cascade
...
create table transactions(
    ...
    created_at timestamp default current_timestamp,
    constraints fk_transactions_account
    foreign key (account_id) references sms_messages(sms_id) on delete cascade null on update cascade,
...
create table balance_snapshots(
    ...
    constraints fk_snapshots_accounts
